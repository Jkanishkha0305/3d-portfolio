...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' Machine Learning Aficionado ', "Data Alchemist ", " Sports Analytics Buff ", " Quiz Connoisseur ",'Innovation Enthusiast '] })
  },[]);
  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      <div className="imgcontainer1 absolute violet-gradient">
        <img src={require("./src/assets/kani.jpeg")} alt="" className="object-contain"/>
      </div>
      </div>
