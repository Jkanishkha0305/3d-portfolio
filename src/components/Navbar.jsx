  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          <img src="/jkbg.png" alt='logo' className='w-9 h-9 object-contain logo' />
        ...
        <div className='sm:flex gap-5'>
          <div
            ...
            >
              <a href="https://drive.google.com/file/d/1LEs0RcqaGXrAdzQnw1FpeFCg0vY5-ZYP/view?usp=sharing" target="_blank"> <b> Resume </b></a>
          </div>
        </div>
      </div>
    </nav>
